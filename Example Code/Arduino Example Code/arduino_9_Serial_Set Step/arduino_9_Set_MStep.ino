...
** 2. If the setting is successful, the LED light will flash slowly, and You can check the detailed settings through the "Read all parameters" button on the host computer or the 47th command of the serial debugging assistant;
...
void loop() {
  ...
  {
    while(1)    //Slow flashing, indicating that the setting is successful (You can check the detailed settings through the "Read all parameters" button on the host computer or the 47th command of the serial debugging assistant;)
    {
