...
** 2. If the setting is successful, the LED light will flash slowly, and You can check the set current through the host computer "Read all parameters" button or serial port debugging assistant 47 command
...
void loop() {
  ...
  {
    while(1)    //The light flashes slowly, indicating that the setting is successful (You can check the set current through the host computer "Read all parameters" button or serial port debugging assistant 47 command)
    {
